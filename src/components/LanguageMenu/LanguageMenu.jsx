  ...
  return (
    <nav className={isVisible ? styles.visibleLanguageNav : styles.languageNav}>
      <ul>
        <li
          className={
            currentLanguage === "en" ? styles.activeMenuItem : styles.menuItem
          }
        ...
        <li
          className={
            currentLanguage === "fr" ? styles.activeMenuItem : styles.menuItem
          }
        ...
        <li
          className={
            currentLanguage === "es" ? styles.activeMenuItem : styles.menuItem
          }
